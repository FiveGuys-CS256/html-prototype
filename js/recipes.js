allTimes = ["5:00", "5:15", "5:30", "5:45", "6:00", "6:15", "6:30", "6:45", "7:00"];
...
allRecipes = {
    "Lab 1": [
        ...
        },
        {
            ...
            timer: {
                '5:15': [{"name": "Rise Dough", "minutes": "60"}],
    ...
    "Lab 2": [
        ...
        },
        {
            ...
            timer: {
                '5:00': [{"name": "Refrigerate Pie Mix", "minutes": "30"}],
                '5:30': [{"name": "Fruit Mix Ready", "minutes": "15"}],
    ...
    "Lab 3": [
        {
            ...
            timer: {
                ...
                '6:15': [],
                '6:30': [],
                '6:45': [{"name":"GrillKabobs","minutes":"10"}],
                '7:00': []
            },
    ...
    "Lab 4": [
        ...
        },
        {
            ...
            timedInstructions: {
                ...
                '5:45': [],
                '6:00': [],
                '6:15': ["Heat the oil in a large skillet over medium heat. Add the garlic and onions and cook for 3 to 4 minutes. " +
            ...
            timer: {
                ...
                '5:45': [],
                '6:00': [],
                '6:15': [{"name":"Cook onions, then rice","minutes":"15"}],
                '6:30': [],
                '6:45': [],
                '7:00': []
            },
    ...
    "Lab 5": [
        ...
        },
        {
            ...
            timer: {
                ...
                '6:15': [],
                '6:30': [],
                '6:45': [{"name":"Remove bread","minutes":"5"}],
                '7:00': []
            },
    ...
    "Lab 6": [
        {
            ...
            "ingredients": [
                ...
                "thinly-sliced green onions, toasted sesame seeds, orange zest",
                "3 cloves garlic, minced",
